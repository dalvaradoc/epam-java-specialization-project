...
public class GeneralController {
  ...
  @Operation(summary = "Login user", description = "Authenticates a user with their credentials", requestBody = @RequestBody(description = "Credentials", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.GENERAL_AUTH_REQBODY))))
  @ApiResponses(value = {
  ...
  @Operation(summary = "Change password", description = "Changes the password for an authenticated user", requestBody = @RequestBody(description = "Current credentials and new password", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.GENERAL_CHANGE_PASSWORD_REQBODY))))
  @ApiResponses(value = {
