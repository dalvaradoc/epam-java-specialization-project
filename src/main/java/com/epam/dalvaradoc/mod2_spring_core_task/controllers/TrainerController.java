...
public class TrainerController {
    ...
    @Operation(
            ...
            description = "Retrieves trainer information by username",
            requestBody =
                    @io.swagger.v3.oas.annotations.parameters.RequestBody(
                            description = "Auth credentials of Trainer",
                            content =
                                    @Content(
                                            mediaType = "application/json",
                                            examples =
                                                    @ExampleObject(
                                                            SwaggerExamples.GENERAL_AUTH_REQBODY))))
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    @Operation(
            ...
            requestBody =
                    @io.swagger.v3.oas.annotations.parameters.RequestBody(
                            description = "Data to create a Trainer",
                            content =
                                    @Content(
                                            mediaType = "application/json",
                                            examples =
    ...
    @Operation(
            ...
            description = "Updates existing trainer information",
            requestBody =
                    @io.swagger.v3.oas.annotations.parameters.RequestBody(
                            description = "Trainer data to be updated",
                            content =
                                    @Content(
                                            mediaType = "application/json",
                                            examples =
    ...
    @Operation(
            summary = "Get trainings of trainer",
            description =
                    "Retrieves a list of trainings for the specified trainer filtered by date"
                            + " range, trainee name and training type",
            requestBody =
                    @io.swagger.v3.oas.annotations.parameters.RequestBody(
    ...
    @Operation(
            summary = "Change active state of trainer",
            description = "Updates the active/inactive status of the trainer",
            requestBody =
                    @io.swagger.v3.oas.annotations.parameters.RequestBody(
                            description = "Authentication data",
                            content =
