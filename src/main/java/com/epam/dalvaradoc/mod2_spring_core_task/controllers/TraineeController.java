...
public class TraineeController {
    ...
    @Operation(summary = "Get trainee by username", description = "Retrieves trainee information by username", requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Authentication details", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.GENERAL_AUTH_REQBODY))))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved trainee details", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.TRAINEE_GET_RESBODY))),
    ...
    @Operation(summary = "Update trainee", description = "Updates existing trainee information", requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Updated trainee details", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.TRAINEE_PUT_REQBODY))))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Trainee successfully updated", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.TRAINEE_PUT_RESBODY))),
            @ApiResponse(responseCode = "401", description = "Bad credentials"),
    })
    @PutMapping
    ...
    @Operation(summary = "Delete trainee", description = "Deletes trainee information", requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Authentication details", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.GENERAL_AUTH_REQBODY))))
    @ApiResponses(value = {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved trainers not assigned to trainee", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.TRAINEE_GET_NOT_ASIGNED_TRAINERS_RESBODY))),
            @ApiResponse(responseCode = "401", description = "Bad credentials"),
    })
    ...
    @Operation(summary = "Add trainer to trainers list", description = "Adds a trainer to the list of trainers of trainee", requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Updated trainers list", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.TRAINEE_ADD_TRAINER_TO_LIST_REQBODY))))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Trainers list successfully updated", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.TRAINEE_ADD_TRAINER_TO_LIST_RESBODY))),
            @ApiResponse(responseCode = "401", description = "Bad credentials"),
    })
    ...
    @Operation(summary = "Get trainings of trainee", description = "Retrieves a list of trainings of the specified trainee", requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Authentication details", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.GENERAL_AUTH_REQBODY))))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved trainings of trainee", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.TRAINEE_GET_TRAININGS_RESBODY))),
            @ApiResponse(responseCode = "401", description = "Bad credentials"),
    })
    ...
    @Operation(summary = "Change active state of trainee", description = "Changes the active state of the specified trainee", requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Authentication details", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.GENERAL_AUTH_REQBODY))))
    @ApiResponses(value = {
