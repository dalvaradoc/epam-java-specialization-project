...
public class TrainerService {
    ...
    public List<TrainerDTO> getAllTrainers() {
        return trainerRepository.findAll().stream().map(mapper::toDTO).toList();
    }
    ...
    public AuthenticationDTO createTrainer(
    ...
    public boolean changeActiveState(boolean active, @Valid AuthenticationDTO auth) {
        Optional<Trainer> trainerOptional =
                Optional.ofNullable(trainerRepository.findByUsername(auth.getUsername()));
