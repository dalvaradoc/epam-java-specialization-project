...
class TraineesTests {
    ...
    void createTraineeTest() {
        AuthenticationDTO auth =
                traineeService.createTrainee(
                        "John", "Smith", "123 Main St", Date.valueOf("2000-01-01"));
    ...
    void updateTraineeTest() {
        ...
        AuthenticationDTO auth =
                traineeService.createTrainee(
                        "Alice", "Brown", "789 Pine St", Date.valueOf("1990-03-10"));
    ...
    void updateTraineeWithBadCredentialsTest() {
        AuthenticationDTO auth =
                traineeService.createTrainee(
                        "Bob", "Wilson", "321 Elm St", Date.valueOf("1988-12-20"));
    ...
    void changePasswordTest() {
        AuthenticationDTO auth =
                traineeService.createTrainee(
                        "Charlie", "Brown", "654 Oak St", Date.valueOf("1992-07-15"));
        ...
        assertThrows(
                BadCredentialsException.class, () -> traineeService.getTraineeByUsername(auth));
    ...
    void changeActiveStateTest() {
        AuthenticationDTO auth =
                traineeService.createTrainee(
                        "David", "Miller", "987 Pine St", Date.valueOf("1987-09-25"));
    ...
    void deleteTraineeTest() {
        AuthenticationDTO auth =
                traineeService.createTrainee(
                        "Eric", "Johnson", "741 Maple St", Date.valueOf("1995-03-15"));
