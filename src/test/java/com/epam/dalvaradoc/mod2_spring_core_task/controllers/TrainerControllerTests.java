...
class TrainerControllerTests {
    ...
    void getTrainerByUsernameTest() throws Exception {
        ...
        MvcResult result =
                mockMvc.perform(
                                get("/trainers/{username}", trainer.getUsername())
        ...
        TrainerDTO trainerDTO =
                objectMapper.readValue(result.getResponse().getContentAsString(), TrainerDTO.class);
    ...
    void changeActiveStateTest() throws Exception {
        ...
        mockMvc.perform(
                        patch("/trainers/{username}/set-active-state", trainer.getUsername())
                                .param("active", "false")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(objectMapper.writeValueAsString(auth)))
                .andExpect(status().isOk());
