...
class TraineesControllerTests {
    ...
    void createBadTraineeTest() throws Exception {
        TraineeDTO badTraineeDTO1 = TraineeDTO.builder()
            .firstName("John123")
            .lastName("Smith")
            .address("123 Main St")
            .birthdate(Date.valueOf("2000-01-01"))
        ...
        TraineeDTO badTraineeDTO2 = TraineeDTO.builder()
            .firstName("John")
            .lastName("Smith123")
            .address("123 Main St")
            .birthdate(Date.valueOf("2000-01-01"))
        ...
        TraineeDTO badTraineeDTO3 = TraineeDTO.builder()
            .firstName("John")
            .lastName("Smith")
            .address("123 Main St")
    ...
    void updateTraineeTest() throws Exception {
        ...
        MvcResult createResult = mockMvc.perform(post("/trainees")
            .contentType(MediaType.APPLICATION_JSON)
            .content(objectMapper.writeValueAsString(traineeDTO)))
            .andExpect(status().isOk())
            .andReturn();
        ...
        MvcResult updateResult = mockMvc.perform(put("/trainees")
            .contentType(MediaType.APPLICATION_JSON)
            .content(objectMapper.writeValueAsString(updateDTO)))
            .andExpect(status().isOk())
            .andReturn();

        TraineeDTO updated = objectMapper.readValue(
    ...
    void changeActiveStateTest() throws Exception {
        ...
        mockMvc.perform(patch("/trainees/{username}/set-active-state", auth.getUsername())
            .param("active", "false")
            .contentType(MediaType.APPLICATION_JSON)
            .content(objectMapper.writeValueAsString(auth)))
            .andExpect(status().isOk());
